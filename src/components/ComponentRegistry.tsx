...
const Kildeavstanden = lazy(() => import('./content/interactive/Kildeavstanden').then(m => ({ default: m.Kildeavstanden })));
...
const NaturensVerdi = lazy(() => import('./content/interactive/NaturensVerdi').then(m => ({ default: m.NaturensVerdi })));
...
const ForbudOgVirkelighet = lazy(() => import('./content/interactive/ForbudOgVirkelighet').then(m => ({ default: m.ForbudOgVirkelighet })));
...
const Bjornespraket = lazy(() => import('./content/interactive/Bjornespraket').then(m => ({ default: m.Bjornespraket })));
...
const MotsattVirkning = lazy(() => import('./content/interactive/MotsattVirkning').then(m => ({ default: m.MotsattVirkning })));
...
const MotVindenUtforsker = lazy(() => import('./content/interactive/MotVindenUtforsker').then(m => ({ default: m.MotVindenUtforsker })));
...
export const componentRegistry: Record<string, React.ComponentType<any>> = {
    ...
    MaktenLangsNilen: lazy(() => import('./content/interactive/MaktenLangsNilen').then(m => ({ default: m.MaktenLangsNilen }))),
